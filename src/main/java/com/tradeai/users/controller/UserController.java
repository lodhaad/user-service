...
import com.tradeai.users.ui.model.request.UserRestUpdateRequest;
...
public class UserController {
	...
	public ResponseEntity<UserRestResponse> updateUser(@RequestBody UserRestUpdateRequest userDetails) {
		...
		UserRestResponse restResponse = mapper.map(updatedUser,UserRestResponse.class );
